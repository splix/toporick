...
Toporick is an Ethereum Smart Contract for storing signatures of off-chain entities in blockchain. This
could be a signatures of digital documents, images, PDF or any other file.
...
Roadmap:
  ...
  1. [X] publish signatures to blockchain - Simple Signature
  2. [ ] add signatures from multiple parties
  3. [ ] verification of signatures
  4. [ ] smart agreement based on state of signatures

== Simple Signature contract
 ...
 * to publish signatures of a downloadable file (like what we have for Ethereum client itself, published on
 official repo. Now it can also be published in blockchain)
 * signature of a correct file before making it public, as a proof of own/existence

Notice that unlike to existing way of publishing such signatures on a website/ftp, publishing to blockchain through
   Toporick, protect signatures from forgery. Once it published on blockchain, it stays here forever.
